...
class FunctionSolverApp:
    ...
    def open_input_dialog(self, func_name):
        ...
        def get_values():
            ...
            try:
                ...
                if func_name == "function21_18":
                    ...
                    result = Functions.function21_58(k=values.get('k (format: comma sperated numbers or decimals in parenthesis. \"(x,x)\")'), r=values.get('r (format: comma sperated numbers or decimals in bracets. \"[x,x,x]\")'), gamma_n=values.get("gamma_n"))
        ...
        if func_name == "function21_18":
            ...
            labels = ["k (format: comma sperated numbers or decimals in parenthesis. \"(x,x)\")", "r (format: comma sperated numbers or decimals in bracets. \"[x,x,x]\")", "gamma_n"]
        elif func_name == "function21_59":
            labels = ["phi", "gamma", "k"]
        elif func_name == "function21_63":
